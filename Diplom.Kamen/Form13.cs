...
namespace Diplom
{
    public partial class Form13 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                double e0 = Convert.ToDouble(textBox2.Text);
                double h = Convert.ToDouble(textBox5.Text);


                textBox15.Text = (Convert.ToString(1 + (e0 / (h / 2))));
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (radioButton5.Checked == true)
            {
                ...
                textBox15.Text = (Convert.ToString(1 + (e0 / (h))));
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            ...
            double e0 = Convert.ToDouble(textBox2.Text);
            textBox6.Text = (Convert.ToString(b * h));
            textBox7.Text = (Convert.ToString(h - 2 * e0));
        }
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            ...
            textBox13.Text = (Convert.ToString(A * (1 - (2 * e0 / h))));
        }

        private void textBox14_TextChanged(object sender, EventArgs e)
        {
            double fs = Convert.ToDouble(textBox14.Text);
            textBox19.Text = (Convert.ToString((1 + fs) / 2));
        }
        ...
        private void textBox9_TextChanged(object sender, EventArgs e)
        {
            ...
            textBox8.Text = (Convert.ToString(((b / 3.4641016151378) + (H / 3.4641016151378)) / 2));
        }
        ...
        private void textBox25_TextChanged(object sender, EventArgs e)
        {
            ...
            double va = double.Parse(textBox25.Text) / Edinici.Razmer;
        ...
        private void textBox26_TextChanged(object sender, EventArgs e)
        {
            ...
            ///////////////////////Объем арматуры/////////////////
            double h = Convert.ToDouble(textBox5.Text);
            double radius = Convert.ToDouble(textBox27.Text) / Edinici.Razmer;
            double H = Convert.ToDouble(textBox9.Text);
            ...
            double A = Convert.ToDouble(textBox6.Text) / Edinici.Razmer;
            ...
            double Rad = Convert.ToDouble(textBox27.Text);
            //textBox21.Text = (Convert.ToString((50 * Rad) / (1 - ((2 * e0) / (h / 2)) * Rs)));
        ...
        private void radioButton9_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                textBox28.Text = (Convert.ToString("2,0"));
            }
        }
        ...
        private void radioButton8_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton8.Checked == true)
            {
                ...
                textBox28.Text = (Convert.ToString("1,5"));
            }
        }
        ...
        private void radioButton7_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton7.Checked == true)
            {
                ...
                textBox28.Text = (Convert.ToString("1,0"));
            }
        }
        ...
        private void textBox21_TextChanged(object sender, EventArgs e)
        {
            ...
            double e0 = Convert.ToDouble(textBox2.Text);
            double h = Convert.ToDouble(textBox5.Text);
            textBox20.Text = (Convert.ToString(R + ((pi * mu * Rs) / 100) * (1 - (2 * e0) / h / 2)));
        ...
        {
            double e0 = Convert.ToDouble(textBox2.Text.Replace(".", ","));
            double A = Convert.ToDouble(textBox6.Text.Replace(".", ","));
            double h = Convert.ToDouble(textBox5.Text.Replace(".", ","));
            double mg = Convert.ToDouble(textBox1.Text.Replace(".", ","));
            double f1 = Convert.ToDouble(textBox19.Text.Replace(".", ","));
            double Ac = Convert.ToDouble(textBox13.Text.Replace(".", ","));
            double wi = Convert.ToDouble(textBox15.Text.Replace(".", ","));
            double Rskb = Convert.ToDouble(textBox20.Text.Replace(".", ","));
            if (e0 <= 17 * h)
            {
                textBox16.Text = (Convert.ToString(mg * f1 * Rskb * Ac * wi * Edinici.RazmerOtvet * Edinici.RazmerOtvetkgtm));
            }

            else
            {
                textBox16.Text = (Convert.ToString(mg * f1 * Rskb * A * (1 - ((2 * e0) / h) * wi) * Edinici.RazmerOtvet * Edinici.RazmerOtvetkgtm));
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            para.Range.Text = "                                            Расчет внецентренно сжатых армированных столбов";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "   ";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "Считается по формуле (для прямоугольного сечения e0 <= 0,17h) N >= mg * φ1 * Rsk * Aс * W";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "Считается по формуле (для прямоугольного сечения) N >= mg * φ1 * Rsk * A * (1 - 2 * e0 / h) W";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "Rskb сопротивление при центральном сжатие будет равно: " + textBox20.Text;
            para.Range.InsertParagraphAfter();
            ...
            para.Range.Text = "Арматура " + comboBox6.Text;
            para.Range.InsertParagraphAfter();
