...
namespace Diplom
{
    public partial class Form10 : Form
    {
        ...
        {
            double f = Convert.ToDouble(textBox19.Text.Replace(".", ","));
            //double fi = Convert.ToDouble(textBox14.Text);
            ...
            double b = Convert.ToDouble(textBox4.Text.Replace(".", ","));
            ...
            textBox16.Text = (Convert.ToString(mg * f * R * Ac * wi * Edinici.RazmerOtvet * Edinici.RazmerOtvetkgtm));
        ...
        {
            double e0 = double.Parse(textBox2.Text);
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            para.Range.Text = "                                            Расчет внецентренно сжатых столбов";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "   ";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "Считается по формуле N >= mg * φ1 * R * Aс * W";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "Вы ввели эксцентриситет расчетной силы " + textBox2.Text;
            para.Range.InsertParagraphAfter();
            ...
            para.Range.Text = "Площадь и площаль сжатой части будет равна: ";
            para.Range.InsertParagraphAfter();

            para.Range.Text = "A: " + textBox6.Text;
            para.Range.InsertParagraphAfter();

            para.Range.Text = "Ac: " + textBox13.Text;
            para.Range.InsertParagraphAfter();

            para.Range.Text = "Далее выбрали коэффициент W, который изчисляется по формуле 1 + (e0 / (h / 2)) " + textBox15.Text;
            para.Range.InsertParagraphAfter();
